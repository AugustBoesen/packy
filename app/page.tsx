...
export default function Index() {
  return (
    <main className='flex-row'>
      <div className='flex flex-col pr-6 md:max-w-[50vw] justify-center'>
        ...
        <h2 className='mb-20 text-center w-full italic bg-gradient-to-r from-emerald-400 via-green-200 to-indigo-200 inline-block text-transparent bg-clip-text'>
          Shape your vision.
        </h2>
        <Link
